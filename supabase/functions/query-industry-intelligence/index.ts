...
// icp_stage, urgency_window, and recency. Used as a precondition before
// invoke_outreach_drafter (see prompt.txt: INDUSTRY INTELLIGENCE PRECONDITION).
...
Deno.serve(async (req: Request) => {
  ...
  let query = supabase
    ...
    .select(
      'notion_page_id, notion_url, title, category, signal_type, source_publication, source_url, source_date, what_happened, so_what, therapeutic_area, icp_stage, buyer_persona, topic_tags, urgency_window, scan_notion_page_id'
    )
