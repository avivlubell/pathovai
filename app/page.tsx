          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              <button
                type="button"
                onClick={() => {
                  if (gmailConnected && driveConnected) {
                    setGoogleMenuOpen((o) => !o);
                  } else {
                    openReconnectPopup(
                      () => {
                        refreshSession?.();
                ...
                aria-label={
                  gmailConnected && driveConnected
                    ...
                    : 'Connect Google (Gmail and Drive)'
                }
                title={
                  gmailConnected && driveConnected
                    ? 'Gmail and Drive connected'
                    : 'Connect Google to enable Gmail search and Drive transcript access'
                }
              ...
              >
                ...
                <span className="hidden sm:inline">
                  {gmailConnected && driveConnected ? 'Google' : 'Connect Google'}
                </span>
                {gmailConnected && driveConnected && (
                  <span
                    aria-hidden="true"
              ...
              {googleMenuOpen && (
                <>
                  ...
                  <div
                    role="menu"
                    className="absolute right-0 top-full z-20 mt-1 w-40 overflow-hidden rounded-md border border-border-strong bg-elevated shadow-lg"
                  >
                    <button
                      role="menuitem"
                      type="button"
                      ...
                      className="block w-full px-3 py-2 text-left text-xs text-fg hover:bg-border focus:outline-none focus:bg-border"
                    >
                      Reconnect
                    </button>
                    <button
                      ...
                      className="block w-full px-3 py-2 text-left text-xs text-danger hover:bg-border focus:outline-none focus:bg-border"
                    >
                      Disconnect
                    </button>
                  </div>
